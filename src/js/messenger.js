...
const api = new API('https://ahj-homework-8-3-serv.herokuapp.com/inst');
...
export default class Messenger {
  constructor() {
    this.url = 'wss://ahj-homework-8-3-serv.herokuapp.com/ws';
  }
  ...
  events() {
    this.elInstances.addEventListener('click', (event) => {
      ...
      if (evtClassList.contains('new-instance')) {
        ...
        const idPatch = event.target.closest('.instance-item').querySelector('.instance-id').innerText;
